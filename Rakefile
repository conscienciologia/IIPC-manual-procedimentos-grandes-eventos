...
PANDOC_COMMAND_TEX="--filter pandoc-latex-environment --standalone --toc --toc-depth=1 --template=template/default.latex --pdf-engine=lualatex --metadata-file=metadata.yaml wip.md --verbose -o wip.tex"
